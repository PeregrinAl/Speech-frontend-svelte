...
<div class="columns-2 text-center rounded-md py-20">
    ...
    <div class="rounded-md py-5">
        <a href="/register/specialist" class="font-mono font-bold sm:text-3xl px-20 py-10 rounded-md text-white font-semibold shadow-sm transition transform hover:-translate-y-3 rounded-md bg-gradient-to-r from-indigo-400 to-teal-400 hover:from-indigo-500 hover:to-green-500">Я - логопед</a>
    </div>
</div>